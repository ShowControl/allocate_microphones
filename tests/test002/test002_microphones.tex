...
\usepackage{hyperref}
\embedfile [desc={parameters}]{test001.txt.parameters.tex}
\input{test001.txt.parameters.tex}
% Pages styles
\makeatletter
...
\makeatother
\embedfile [desc={input file to allocate\_microphones}]{test001.txt}
\pagestyle{Standard}
...
\embedfile [desc={input file}] {test001.txt.assignments.tex}
\begin{center}
\begin{longtable}{|l|m{7in}|}
\hline Mic. & Assignment \endhead \hline
\input {test001.txt.assignments.tex}
\end{longtable}
\end{center}

\section {Microphone Moves, by Page}

\embedfile [desc={input file}] {test001.txt.microphone_moves.tex}
\begin{center}
\begin{longtable}{|l|m{7in}|}
\hline page & moves \endhead \hline
\input {test001.txt.microphone_moves.tex}
\end{longtable}
\end{center}
...
\vskip 0.25in
\embedfile [desc={input file}] {test001.txt.actors.tex}
{\setlength{\parindent}{0in}
\input {test001.txt.actors.tex}
}
...
\embedfile [desc={input file}] {test001.txt.stage_manager_before_show.tex}
\begin{center}
\begin{longtable}{|l|l|}
\hline Mic. & Actor \endhead \hline
\input {test001.txt.stage_manager_before_show.tex}
\end{longtable}
\end{center}
...
\embedfile [desc={input file}] {test001.txt.stage_manager_during_show.tex}
\begin{center}
\begin{longtable}{|l|l|l|l|}
\hline page & Mic. & Direction & Actor \endhead \hline
\input {test001.txt.stage_manager_during_show.tex}
\end{longtable}
\end{center}
...
\embedfile [desc={input file}] {test001.txt.stage_manager_after_show.tex}
\begin{center}
\begin{longtable}{|l|l|}
\hline Mic. & Actor \endhead \hline
\input {test001.txt.stage_manager_after_show.tex}
\end{longtable}
\end{center}
...
\embedfile [desc={input file}] {test001.txt.stage_manager_at_intermission.tex}
\begin{center}
\begin{longtable}{|l|l|}
\hline Mic. & Actor \endhead \hline
\input {test001.txt.stage_manager_at_intermission.tex}
\end{longtable}
\end{center}
...
\embedfile [desc={input file}] {test001.txt.microphone_switching_annotated.tex}
\input {test001.txt.microphone_switching_annotated.tex}

\subsection {Cue summary}

Here are the cues again, in summary form, organized by DCA.

\embedfile [desc={input file}] {test001.txt.DCA_usage.tex}
\begin{center}
  \begin{longtable}{|p{0.75 in}|p{0.75 in}|p{0.75 in}|p{0.75 in}|p{0.75 in}|p{0.75 in}|p{0.75 in}|p{0.75 in}|p{0.75 in}|}    
    ...
    \input {test001.txt.DCA_usage.tex}
  \end{longtable}
\end{center}
...
\embedfile [desc={input file}] {test001.txt.microphone_labels.tex}
{\Large
\input {test001.txt.microphone_labels.tex}
}
...
\embedfile [desc={input file}] {test001.txt.microphone_channels.tex}
{\Large
\input {test001.txt.microphone_channels.tex}
}
...
\embedfile [desc={input file}] {test001.txt.microphone_switching.tex}
\input {test001.txt.microphone_switching.tex}
